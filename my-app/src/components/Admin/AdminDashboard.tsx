  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      try {
        ...
        if (!cancelled) message.error("Failed to load staff performance");
      } finally {
            ...
            <div>
              ...
              <Menu
                ...
                items={[
                  ...
                  { key: "7", icon: <FileTextOutlined />, label: "Audit Log" },
                  { key: "8", icon: <BarChartOutlined />, label: "Staff Performance" },
                  { key: "9", icon: <StarOutlined />, label: "Reviews" },
        ...
        <Content style={{ padding: "30px", background: "transparent" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 24 }}>
            <Title level={3} style={{ margin: 0 }}>
              ...
              {activeKey === "7" && "Audit Log"}
              {activeKey === "8" && "Staff Performance"}
              {activeKey === "9" && "Reviews"}
